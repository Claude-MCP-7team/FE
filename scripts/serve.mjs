...
const shared = ['/profile.html', '/src/profile.js', '/src/profile-form.js', '/src/profile-page.js', '/src/profile.css', '/src/dom.js', '/src/profile-repository.js', '/src/judgement-api.js', '/src/judgement-contract.js', '/src/judgement-page.js', '/src/judgement-runner.js', '/src/question-api.js', '/src/question-contract.js', '/src/question-page.js', '/src/combination-api.js', '/src/combination-contract.js', '/src/combination-page.js'];
