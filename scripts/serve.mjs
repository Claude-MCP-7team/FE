...
const shared = ['/profile.html', '/src/profile.js', '/src/profile-form.js', '/src/profile-page.js', '/src/profile.css', '/src/dom.js', '/src/profile-repository.js', '/src/judgement-api.js', '/src/judgement-contract.js'];
